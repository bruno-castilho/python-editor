...
import { makeVerifyEmailUseCase } from '../infra/factories/make-verify-email'
import { makeResendEmailVerificationUseCase } from '../infra/factories/make-resend-email-verification'
import { makeForgotPasswordUseCase } from '../infra/factories/make-forgot-password'
import { makeResetPasswordUseCase } from '../infra/factories/make-reset-password'
import { makeGetProfileUseCase } from '../infra/factories/make-get-profile'
import { makeUpdateProfileUseCase } from '../infra/factories/make-update-profile'
import { makeRemoveAvatar } from '../infra/factories/make-remove-avatar'
import { makeGetUserSessionsUseCase } from '../infra/factories/make-get-user-sessions'
import { makeRevokeUserSessionUseCase } from '../infra/factories/make-revoke-user-session'
